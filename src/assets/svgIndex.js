...
import BedsideTable from './svg/BedsideTable';
import Brush from './svg/Brush';
import CallendarWorkout from './svg/CallendarWorkout';
import Camera from './svg/Camera';
import DeskLamp from './svg/DeskLamp';
import Earphones from './svg/Earphones';
import GamePad from './svg/GamePad';
import HealthyFood from './svg/HealthyFood';
import Hospital from './svg/Hospital';
import Hygienic from './svg/Hygienic';
import JunkFood from './svg/JunkFood';
import Liquid from './svg/Liquid';
import Magnifier from './svg/Magnifier';
import Money from './svg/Money';
import Movie from './svg/Movie';
import PlanList from './svg/PlanList';
import Sleep from './svg/Sleep';
import Stool from './svg/Stool';
...
export const SvgComponents = [
    ...
    { 'location': 'CallendarWorkout.js', 'component': CallendarWorkout },
    { 'location': 'Hygienic.js', 'component': Hygienic },
    { 'location': 'JunkFood.js', 'component': JunkFood },
    { 'location': 'Sleep.js', 'component': Sleep },
    { 'location': 'HealthyFood.js', 'component': HealthyFood },
    { 'location': 'Hospital.js', 'component': Hospital },
    { 'location': 'Weight.js', 'component': Weight },
...
export const SvgFileNamesToComponentsMap = {
    'AlarmClock.js': AlarmClock,
    'BedsideTable.js': BedsideTable,
    'Brush.js': Brush,
    'CallendarWorkout.js': CallendarWorkout,
    'Camera.js': Camera,
    'DeskLamp.js': DeskLamp,
    'Earphones.js': Earphones,
    'GamePad.js': GamePad,
    'HealthyFood.js': HealthyFood,
    'Hospital.js': Hospital,
    'Hygienic.js': Hygienic,
    'JunkFood.js': JunkFood,
    'Liquid.js': Liquid,
    'Magnifier.js': Magnifier,
    'Money.js': Money,
    'Movie.js': Movie,
    'PlanList.js': PlanList,
    'Sleep.js': Sleep,
    'Stool.js': Stool,
    'Suitcase.js': Suitcase,
    'Trophy.js': Trophy,
    'Wallet.js': Wallet,
    'Weight.js': Weight,
};